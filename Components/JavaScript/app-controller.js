...
app.controller("CRMAppctrl",function($scope){
	...
	{name:'Charan',phone:'9564287634',campaign:'Request return',status:'Pending'},
	{name:'Mark',phone:'9706835421',campaign:'Update Aadhar',status:'Pending'},
	{name:'Aditya',phone:'9567768521',campaign:'Request return',status:'Pending'},
	...
	{name:'Nagaraj',phone:'7865485421',campaign:'Request return',status:'Pending'},
	...
	$scope.completedlist=[{name:'Nilofer',phone:'8756506413',campaign:'Lost Debit Card',status:'Completed'},
	{name:'Aniket',phone:'7595468635',campaign:'Lost Debit Card',status:'Completed'},
	{name:'Paul',phone:'9764893527',campaign:'Update Aadhar',status:'Completed'}];
